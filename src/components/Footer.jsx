...
const Footer = () => {
    return (
        <footer className="w-full pb-2 mt-4 bg-[--charcoal] text-white overflow-x-hidden text-sm sm:text-base">
            <div id="ftop-section" className="flex flex-col gap-3 sm:gap-5 justify-evenly items-center">
                ...
                <div id="fNav" className="w-full text-center text-xs sm:text-base flex flex-row flex-wrap justify-center gap-2 sm:gap-x-4 md:gap-x-6 px-2">
                ...
                <div className="w-32 sm:w-40 md:w-48 my-4 sm:my-6"><img className="w-full" src="/src/assets/mm-logo-white.svg" alt="logo-white" /></div>
            </div>
            <div id="fbottom-section" className="text-center">
                <div>Movie Mania | By Jatin Kaushik</div>
                <div className="text-[#ccc] text-xs sm:text-sm">Source TMDB</div>
            </div>
        </footer>
    )
}
