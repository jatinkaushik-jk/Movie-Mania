...
const MovieCard = ({ movieData }) => {
    ...
    return (
        <div onClick={handleCardClick} className="group w-36 h-56 sm:w-40 sm:h-72 lg:w-52 lg:h-96 rounded-md bg-white overflow-hidden cursor-pointer shadow-[0_0_1rem_rgba(0,0,0,0.2)]">
            ...
            <div className="w-full h-1/5 flex sm:flex-row flex-col-reverse items-center text-xs sm:text-base font-medium py-1 px-2 sm:gap-y-0 gap-y-[0.1rem]">
                <h5 className="w-full sm:w-3/5 leading-3 sm:leading-none">{movieData.title}</h5>
